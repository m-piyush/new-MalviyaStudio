...
function ExperienceSection() {
    return (
        <div className="w-full max-w-6xl mx-auto bg-gradient-to-br from-[#fff1eb] to-[#d8f3ff] dark:from-card dark:to-muted dark:border dark:border-border p-6 sm:p-12 rounded-2xl shadow-2xl">
            <p className="uppercase tracking-widest text-sm md:text-base text-brand mb-2 font-semibold">
                Helping couples bring to life
            </p>
            <h3 className="text-2xl md:text-4xl font-bold text-foreground mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                {[
                    ...
                    <div
                        key={idx}
                        className="bg-card text-card-foreground border border-border rounded-2xl shadow-lg py-8 px-6 hover:shadow-xl transition-all duration-300"
                    >
                        <h4 className="text-4xl md:text-5xl font-extrabold text-brand">{stat.value}</h4>
