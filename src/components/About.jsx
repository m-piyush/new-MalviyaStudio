...
function AboutSection() {
    return (
        <div className="flex flex-col-reverse md:flex-row items-center max-w-6xl mx-auto bg-gradient-to-br from-[#ffe2e2] to-[#fff1eb] dark:from-card dark:to-muted dark:border dark:border-border p-4 rounded-2xl shadow-2xl gap-10">
            ...
            <div className="md:w-1/2 text-center md:text-left px-6 flex flex-col justify-center gap-2 md:gap-2">
                <blockquote className="text-brand text-5xl leading-none">“</blockquote>

                <p className="text-foreground text-base md:text-lg leading-relaxed font-medium max-w-md mx-auto md:mx-0">
                ...
                />
                <p className="text-foreground font-bold text-lg">Sharad Malviya</p>
                <button className="mt-4 w-max mx-auto md:mx-0 px-6 py-3 bg-brand text-brand-foreground rounded-full hover:bg-brand/90 transition-all shadow-md">
